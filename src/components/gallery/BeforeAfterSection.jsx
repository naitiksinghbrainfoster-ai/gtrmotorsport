    ...
    <section className="overflow-hidden bg-black py-12 sm:py-14 lg:py-12">
      <div className="mx-auto max-w-[1550px] px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* BEFORE IMAGE */}
          {/* Fixed: uses same full-size w-full/h-full object-cover as the After image,
              and reveals only the "before" portion via clip-path instead of a fixed
              1400px width + percentage-width wrapper. This is what broke on mobile —
              the old wrapper clipped a 1400px-wide image inside a much narrower
              container, so only a small zoomed-in slice was visible. */}
          <img
